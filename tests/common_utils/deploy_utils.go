...
type Config struct {
	...
	DnsDomainNames             string `yaml:"dns_domain_names"`
	EnableAppCenter            bool   `yaml:"enable_app_center"`
	AppCenterGuiPassword       string `yaml:"app_center_gui_pwd"`
	...
	EUGBZone                   string `yaml:"eu_gb_zone"`
	EUGBClusterID              string `yaml:"eu_gb_cluster_id"`
	EUGBReservationID          string `yaml:"eu_gb_reservation_id"`
...
func setEnvFromConfig(config *Config) error {
	envVars := map[string]interface{}{
		...
		"EU_GB_ZONE":                    config.EUGBZone,
		"EU_GB_RESERVATION_ID":          config.EUGBReservationID,
		"EU_GB_CLUSTER_ID":              config.EUGBClusterID,
