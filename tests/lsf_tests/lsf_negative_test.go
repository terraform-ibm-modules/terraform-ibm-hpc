...
// 			utils.VerifyDataContains(t, err.Error(), "allowed_cidr", testLogger)
...
// 		envVars.DefaultExistingResourceGroup, kmsInstanceName, lsf.KMS_KEY_NAME, testLogger)
...
// 	options, err := setupOptionsVpc(t, hpcClusterPrefix, createVpcTerraformDir,
// 		envVars.DefaultExistingResourceGroup, ignoreDestroys, ignoreUpdates)
...
// 			"If the cluster_subnet_ids are provided, the user should also provide the vpc_name",
...
// 			"Provided existing cluster_subnet_ids should have public gateway attached",
// 		}
...
// 		assert.True(t, validationPassed)
// 		testLogger.LogValidationResult(t, validationPassed, "Without VPC name and with valid cluster_subnet_ids and login_subnet_id")
// 	} else {
