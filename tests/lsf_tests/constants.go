...
const (
	...
	LSF_DEFAULT_EXISTING_RESOURCE_GROUP                       = "Default"
	LSF_CUSTOM_EXISTING_RESOURCE_GROUP_VALUE_AS_NULL          = "null"
	LSF_CUSTOM_EXISTING_RESOURCE_GROUP_OTHER_THAN_DEFAULT     = "WES_TEST"
