...
func VerifyCloudLogs(
	...
	// Verify Fluent Bit service for compute nodes
	compErr := LSFFluentBitServiceForComputeNodes(t, sshClient, staticWorkerNodeIPList, isCloudLogsEnabledForCompute, logger)
	utils.LogVerificationResult(t, compErr, "Fluent Bit service for compute nodes", logger)
...
func VerifyCloudMonitoring(
	...
	compErr := LSFDragentServiceForComputeNodes(t, sshClient, staticWorkerNodeIPList, isCloudMonitoringEnabledForCompute, logger)
