...
locals {
  env = {
    ...
    app_center_high_availability                     = lookup(local.override[local.override_type], "app_center_high_availability", local.config.app_center_high_availability )
    app_center_existing_certificate_instance         = lookup(local.override[local.override_type], "app_center_existing_certificate_instance", local.config.app_center_existing_certificate_instance )
