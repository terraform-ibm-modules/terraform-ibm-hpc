...
variable "ldap_basedns" {
  ...
  validation {
    condition     = var.enable_ldap == false || (var.ldap_basedns != null && length(trimspace(var.ldap_basedns)) > 0 && var.ldap_basedns != "null")
...
variable "ldap_server_cert" {
  ...
  validation {
    condition     = var.enable_ldap == false || var.ldap_server == null || (var.ldap_server_cert != null ? (length(trimspace(var.ldap_server_cert)) > 0 && var.ldap_server_cert != "null") : true)
