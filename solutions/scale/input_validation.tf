...
locals {
  ...
  total_storage_instance_count  = var.storage_type == "persistent" ? sum(var.storage_servers[*]["count"]) : sum(var.storage_instances[*]["count"])
  ...
  compute_sg_rules = flatten([for remote in data.ibm_is_security_group.cluster_security_group[*].rules[*] : remote[*].remote])
  ...
  comp_condition    = var.enable_sg_validation == true && local.total_compute_instance_count > 0 && var.cluster_security_group_name != null
  ...
  validate_comp_sg_in_strg_sg = local.comp_condition ? contains(local.storage_sg_rules, tolist(data.ibm_is_security_group.cluster_security_group[*].id)[0]) : true
  ...
  # tflint-ignore: terraform_unused_declarations
  validate_strg_sg_in_comp_sg_chk = var.cluster_security_group_name != null ? regex("^${local.strg_sg_in_comp_sg_msg}$", (local.validate_strg_sg_in_comp_sg ? local.strg_sg_in_comp_sg_msg : "")) : true

  validate_comp_sg_in_comp_sg = local.comp_condition ? contains(local.compute_sg_rules, tolist(data.ibm_is_security_group.cluster_security_group[*].id)[0]) : true
  comp_sg_in_comp_sg_msg      = "The Compute security group does not include the compute security group as a rule."
  # tflint-ignore: terraform_unused_declarations
  validate_comp_sg_in_comp_sg_chk = var.cluster_security_group_name != null ? regex("^${local.comp_sg_in_comp_sg_msg}$", (local.validate_comp_sg_in_comp_sg ? local.comp_sg_in_comp_sg_msg : "")) : true
  ...
  # tflint-ignore: terraform_unused_declarations
  validate_client_sg_in_comp_sg_chk = var.cluster_security_group_name != null ? regex("^${local.client_sg_in_comp_sg_msg}$", (local.validate_client_sg_in_comp_sg ? local.client_sg_in_comp_sg_msg : "")) : true
  ...
  # tflint-ignore: terraform_unused_declarations
  validate_gklm_sg_in_comp_sg_chk = var.cluster_security_group_name != null ? regex("^${local.gklm_sg_in_comp_sg_msg}$", (local.validate_gklm_sg_in_comp_sg ? local.gklm_sg_in_comp_sg_msg : "")) : true
  ...
  # tflint-ignore: terraform_unused_declarations
  validate_ldap_sg_in_comp_sg_chk = var.cluster_security_group_name != null ? regex("^${local.ldap_sg_in_comp_sg_msg}$", (local.validate_ldap_sg_in_comp_sg ? local.ldap_sg_in_comp_sg_msg : "")) : true
  ...
  # tflint-ignore: terraform_unused_declarations
  validate_bastion_sg_in_comp_sg_chk = var.cluster_security_group_name != null ? regex("^${local.bastion_sg_in_comp_sg_msg}$", (local.validate_bastion_sg_in_comp_sg ? local.bastion_sg_in_comp_sg_msg : "")) : true
  ...
  validate_comp_sg_in_gklm_sg = local.comp_condition ? contains(local.gklm_sg_rules, tolist(data.ibm_is_security_group.cluster_security_group[*].id)[0]) : true
  ...
  validate_comp_sg_in_ldap_sg = local.comp_condition ? contains(local.ldap_sg_rules, tolist(data.ibm_is_security_group.cluster_security_group[*].id)[0]) : true
  ...
  validate_comp_sg_in_client_sg = local.comp_condition ? contains(local.client_sg_rules, tolist(data.ibm_is_security_group.cluster_security_group[*].id)[0]) : true
...
locals {
  ...
  validate_subnet_id_ext_vpc = alltrue([
    var.vpc_name != null && (var.storage_subnet_id != null || var.cluster_subnet_id != null || var.protocol_subnet_id != null || var.client_subnet_id != null || var.login_subnet_id != null) ?
    ...
    ((local.total_compute_instance_count > 0 && var.cluster_subnet_id != null) ? true : ((local.total_compute_instance_count == 0 && var.cluster_subnet_id == null) ? true : false)) &&
