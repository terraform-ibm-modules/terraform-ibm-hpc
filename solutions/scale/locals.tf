...
locals {
  env = {
    ...
    tie_breaker_bm_server_profile       = lookup(local.override[local.override_type], "tie_breaker_bm_server_profile", local.config.tie_breaker_bm_server_profile)
    ...
    cluster_security_group_name         = lookup(local.override[local.override_type], "cluster_security_group_name", local.config.cluster_security_group_name)
