...
locals {
  ...
  storage_instances   = var.enable_deployer ? [] : flatten([module.landing_zone_vsi[0].protocol_vsi_data, module.landing_zone_vsi[0].storage_vsi_data, module.landing_zone_vsi[0].afm_vsi_data, module.landing_zone_vsi[0].storage_cluster_tie_breaker_vsi_data, module.landing_zone_vsi[0].storage_cluster_management_vsi])
