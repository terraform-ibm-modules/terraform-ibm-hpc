...
locals {
  ...
  compute_public_key_contents  = var.enable_deployer ? "" : join("", flatten([module.landing_zone_vsi[0].compute_public_key_content]))
  compute_private_key_contents = var.enable_deployer ? "" : join("", flatten([module.landing_zone_vsi[0].compute_private_key_content]))
