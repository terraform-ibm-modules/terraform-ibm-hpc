...
locals {
  ...
  vpc_id                     = var.vpc == null ? one(module.landing_zone.vpc_id) : data.ibm_is_vpc.existing_vpc[0].id
...
#   existing_subnets = flatten([
#     for existing_subnet_type in local.existing_subnet_types : [
#       {
#         "${existing_subnet_type}" = flatten([
#           for subnet in (
#             existing_subnet_type == "existing_compute_subnets" ? data.ibm_is_subnet.existing_compute_subnets :
#             existing_subnet_type == "existing_storage_subnets" ? data.ibm_is_subnet.existing_storage_subnets :
#             existing_subnet_type == "existing_protocol_subnets" ? data.ibm_is_subnet.existing_protocol_subnets :
#             existing_subnet_type == "existing_client_subnets" ? data.ibm_is_subnet.existing_client_subnets :
#             []
#           ) : {
...
#   storage_subnets = flatten([
#     var.vpc != null && var.storage_subnets != null ?
#       [
#         for subnet_map in local.existing_subnets : 
#         subnet_map["existing_storage_subnets"] if contains(keys(subnet_map), "existing_storage_subnets")
#       ] : [module.landing_zone.storage_subnets] 
#   ])

#   compute_subnets = flatten([
#     var.vpc != null && var.compute_subnets != null ?
#       [
#         for subnet_map in local.existing_subnets : 
#         subnet_map["existing_compute_subnets"] if contains(keys(subnet_map), "existing_compute_subnets")
#       ] : [module.landing_zone.compute_subnets] 
#   ])

#   protocol_subnets = flatten([
#     var.vpc != null && var.protocol_subnets != null ?
#       [
#         for subnet_map in local.existing_subnets : 
#         subnet_map["existing_protocol_subnets"] if contains(keys(subnet_map), "existing_protocol_subnets")
#       ] : [module.landing_zone.protocol_subnets] 
#   ])

#   client_subnets = flatten([
#     var.vpc != null && var.client_subnets != null ?
#       [
#         for subnet_map in local.existing_subnets : 
#         subnet_map["existing_client_subnets"] if contains(keys(subnet_map), "existing_client_subnets")
#       ] : [module.landing_zone.client_subnets] 
#   ])
...
locals {
  ...
  client_subnets   = var.vpc != null && var.client_subnets != null ? local.existing_client_subnets[*].name : module.landing_zone.client_subnets[*].name
  compute_subnets  = var.vpc != null && var.compute_subnets != null ? local.existing_compute_subnets[*].name : module.landing_zone.compute_subnets[*].name
  storage_subnets  = var.vpc != null && var.storage_subnets != null ? local.existing_storage_subnets[*].name : module.landing_zone.storage_subnets[*].name
  protocol_subnets = var.vpc != null && var.protocol_subnets != null ? local.existing_protocol_subnets[*].name : module.landing_zone.protocol_subnets[*].name
...
locals {
  ...
  compute_subnet_id         = var.vpc != null && var.client_subnets != null ? local.existing_client_subnets[*].id : module.landing_zone.client_subnets[*].id
