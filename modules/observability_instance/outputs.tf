...
output "cloud_monitoring_url" {
  value       = var.enable_deployer && var.cloud_monitoring_provision ? "https://cloud.ibm.com/observe/embedded-view/monitoring/${module.observability_instance[0].cloud_monitoring_guid}" : null
