...
#   value       = var.enable_deployer && var.cloud_monitoring_provision ? module.observability_instance[0].cloud_monitoring_access_key : null
...
#   value       = var.cloud_logs_provision ? module.observability_instance[0].cloud_logs_ingress_endpoint : null
#   description = "The public ingress endpoint of the provisioned Cloud Logs instance."
# }

# output "cloud_logs_ingress_private_endpoint" {
#   value       = var.cloud_logs_provision ? module.observability_instance[0].cloud_logs_ingress_private_endpoint : ""
...
#   value       = var.cloud_logs_provision ? "https://dashboard.${var.location}.logs.cloud.ibm.com/${module.observability_instance[0].cloud_logs_guid}" : null
