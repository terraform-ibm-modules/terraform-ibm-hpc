provider "logdna" {
  alias      = "ats"
  servicekey = module.observability_instance.activity_tracker_ats_resource_key != null ? module.observability_instance.activity_tracker_ats_resource_key : ""
  url        = local.logs_instance_endpoint
}

provider "logdna" {
  alias      = "sts"
  servicekey = module.observability_instance.log_analysis_sts_resource_key != null ? module.observability_instance.log_analysis_sts_resource_key : ""
  url        = local.logs_instance_endpoint
}
