data "template_file" "client_user_data" {
  ...
  vars = {
    ...
    client_public_key_content  = local.enable_client ? var.compute_public_key_content : ""
    client_private_key_content = local.enable_client ? var.compute_private_key_content : ""
...
data "template_file" "management_user_data" {
  ...
  vars = {
    bastion_public_key_content     = var.bastion_public_key_content != null ? var.bastion_public_key_content : ""
    management_public_key_content  = local.enable_management ? var.compute_public_key_content : ""
    management_private_key_content = local.enable_management ? var.compute_private_key_content : ""
...
data "template_file" "compute_user_data" {
  ...
  vars = {
    bastion_public_key_content  = var.bastion_public_key_content != null ? var.bastion_public_key_content : ""
    compute_public_key_content  = local.enable_compute ? var.compute_public_key_content : ""
    compute_private_key_content = local.enable_compute ? var.compute_private_key_content : ""
