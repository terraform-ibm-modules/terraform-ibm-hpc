...
variable "security_group_id" {
  type        = string
  description = "The ID of the storage security group."
}

variable "compute_security_group_id" {
  type        = string
  default     = ""
  description = "The ID of the compute security group. Empty string if no compute SG exists."
}

variable "client_security_group_id" {
  type        = string
  default     = ""
  description = "The ID of the client security group. Empty string if no client SG exists."
}
