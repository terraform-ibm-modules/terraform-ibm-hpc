...
export IC_API_KEY=${ibmcloud_api_key} && sudo -E terraform -chdir=${remote_ansible_path}/modules/landing_zone_vsi init && sudo -E terraform -chdir=${remote_ansible_path}/modules/landing_zone_vsi apply -auto-approve \
