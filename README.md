...
| <a name="input_file_shares"></a> [file\_shares](#input\_file\_shares) | Custom file shares to access shared storage | <pre>list(<br>    object({<br>      mount_path = string,<br>      size       = number<br>    })<br>  )</pre> | <pre>[<br>  {<br>    "mount_path": "/mnt/binaries",<br>    "size": 100<br>  },<br>  {<br>    "mount_path": "/mnt/data",<br>    "size": 100<br>  }<br>]</pre> | no |
