...
| <a name="input_enable_cloud_monitoring"></a> [enable\_cloud\_monitoring](#input\_enable\_cloud\_monitoring) | Set false to disable IBM Cloud Monitoring integration. If enabled, infrastructure and LSF application metrics from Management Nodes will be ingested. | `bool` | `false` | no |
| <a name="input_enable_cloud_monitoring_compute_nodes"></a> [enable\_cloud\_monitoring\_compute\_nodes](#input\_enable\_cloud\_monitoring\_compute\_nodes) | Set false to disable IBM Cloud Monitoring integration. If enabled, infrastructure metrics from Compute Nodes will be ingested. | `bool` | `false` | no |
...
| <a name="input_storage_security_group_id"></a> [storage\_security\_group\_id](#input\_storage\_security\_group\_id) | Existing storage security group id | `string` | `null` | no |
